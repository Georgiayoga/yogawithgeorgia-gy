...
export const metadata = {
  ...
  description:
    "Join Georgia for a transformative Iyengar Yoga retreat at Ulpotha, Sri Lanka, January-February 2027. Experience daily yoga practice in one of the world's most renowned yoga centres set in a traditional farming village.",
  keywords:
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-centre mb-12">
            ...
            <p className="font-body text-lg text-brand-orange font-medium text-center">January 31–February 14, 2027</p>
          </header>
              ...
              <AccordionItem value="getting-there">
                ...
                <AccordionContent className="font-body text-brand-black/80">
                  <div className="space-y-3">
                    ...
                    <p>
                      <strong>Arrival Day:</strong> Please plan to arrive on January 31st. The retreat officially begins
                      with a yoga class at 17:30 followed by the welcome dinner. Departure is after breakfast on
                      February 14th.
                    </p>
                  </div>
                </AccordionContent>
